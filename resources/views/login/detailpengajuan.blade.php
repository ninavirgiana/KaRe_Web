                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $item)
                                        <form method="POST"
                                            action="{{ route('formulirkunjungan', ['id' => $item->id]) }}">
                                            <tr>
                                                <td>{{ $no++ }}</td>
                                                ...
                                                <td>
                                                    @if ($item->status_kunjungan == 'diajukan')
                                                        <button
                                                            class="btn btn-warning disabled-button">diajukan</button>
                                                    @elseif($item->status_kunjungan == 'diterima')
                                                        <button
                                                            class="btn btn-success disabled-button">diterima</button>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif ($item->status_kunjungan != 'diajukan')
                                                        <a href="{{ url('formulirkunjungan/' . $item->id_kunjungan . '/alasan') }}"
